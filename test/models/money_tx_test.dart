...
void main() {
  group('MoneyTx Tests', () {
    test('costruttore deve creare oggetto valido', () {
      ...
      expect(tx.category, ExpenseCategory.spesa);
    ...
    test('copyWith deve funzionare correttamente', () {
      ...
      expect(modified.roommateId, original.roommateId); // Non modificato
      expect(modified.category, original.category); // Non modificato
    });
